class ApplicationSettingsController < ApplicationController
  ...
  def create
    ...
    @application_setting.post_id = params[:post_id]

    respond_to do |format|
      if @application_setting.save
        format.html { redirect_to @application_setting.post, notice: 'Application setting was successfully created.' }
  ...
  private
    ...
    def application_setting_params
      params.require(:application_setting).permit(:name, :about, :email, :phone, :project_title, :project_description, :age)
    end
end
