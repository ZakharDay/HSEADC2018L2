...
class ApplicationSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create application_setting" do
    assert_difference('ApplicationSetting.count') do
      post application_settings_url, params: { application_setting: { about: @application_setting.about, age: @application_setting.age, email: @application_setting.email, name: @application_setting.name, phone: @application_setting.phone, project_description: @application_setting.project_description, project_title: @application_setting.project_title } }
    end
  ...
  test "should update application_setting" do
    patch application_setting_url(@application_setting), params: { application_setting: { about: @application_setting.about, age: @application_setting.age, email: @application_setting.email, name: @application_setting.name, phone: @application_setting.phone, project_description: @application_setting.project_description, project_title: @application_setting.project_title } }
